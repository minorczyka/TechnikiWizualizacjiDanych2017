...
Ostatnio pomaga³em za³atwiæ formalnoœci mojej przyjació³ki w zwi¹zku z wyjazdem do Australii i to natchnê³o mnie do poszukania informacji na temat tamtego rejonu. Pad³o na artyku³ na temat wyborów w Nowej Zelandii:

- “http://www.newshub.co.nz/home/election/2017/09/nz-elections-2017-live-results.html”

Nie uda³o mi siê scrapowaæ strony ze wzglêdu na interaktywnoœæ danych, wiêc z pomoc¹ przysz³y ctrl+c, ctrl+v oraz delikatne przekszta³cenia, aby kolejnoœæ danych na wykresach by³a odpowiednia.
...
Tabele w tym momencie wygl¹daj¹ nastêpuj¹co:
...
Teraz trzeba to wszystko przekszta³ciæ do formatu, który bêdzie ³atwy do zrozumienia przez ``ggplot2``. W tym celu zastosowa³em pakiet ``tidyr``. Zdecydowa³em siê na zobrazowanie dwóch tabel.
